...
Create table dev01.ResponseHistory
(
    Reference       varchar(11) Not Null,
    Period          char(6) Not Null,
    ...
    OldResponse     varchar(256) Not Null,
    NewResponse     varchar(256) Not Null,
    UpdatedBy       varchar(16) Not Null,
    UpdatedDate     timestamptz
);
Create Index idx_responsehistory_referenceperiodsurveyquestioncode On dev01.ResponseHistory(Reference, Period, Survey, QuestionCode);

Create rule AuditUpdate As On Update To dev01.response
Where new.response <> old.response
do Insert Into dev01.ResponseHistory
Values 
    (new.reference,
    new.period,
    new.survey,
...
Create rule AuditDelete As On Delete To dev01.response
do Insert Into dev01.ResponseHistory
Values 
    (old.reference,
    old.period,
...
Values
    ...
    ('074','101',current_user, Now()),
    ('074','102',current_user, Now()),
    ('074','103',current_user, Now()),
    ('074','104',current_user, Now()),
    ('074','201',current_user, Now()),
    ('074','202',current_user, Now()),
    ('074','203',current_user, Now()),
    ('074','204',current_user, Now()),
    ('074','211',current_user, Now()),
    ('074','212',current_user, Now()),
    ('074','213',current_user, Now()),
    ('074','214',current_user, Now()),
    ('074','221',current_user, Now()),
    ('074','222',current_user, Now()),
    ('074','223',current_user, Now()),
    ('074','224',current_user, Now()),
    ('074','301',current_user, Now()),
    ('074','302',current_user, Now()),
    ('074','303',current_user, Now()),
    ('074','304',current_user, Now()),
    ('074','311',current_user, Now()),
    ('074','312',current_user, Now()),
    ('074','313',current_user, Now()),
    ('074','314',current_user, Now()),
    ('074','321',current_user, Now()),
    ('074','322',current_user, Now()),
    ('074','323',current_user, Now()),
    ('074','324',current_user, Now());
...
Values
    ...
    (10,1,'QvDQ','601','','W',current_user,now()),
    (11,1,'QvDQ','602','','W',current_user,now());
